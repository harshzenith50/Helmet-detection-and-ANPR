...
def parse_arguments(args_hook=lambda _: _):
    parser = argparse.ArgumentParser(
        ...
        epilog="""Examples:'
Process images from a folder: python plate_recognition.py -a 29ee3c4e83e51723e22d0eaa284502947d6df535 /path/to/vehicle-*.jpg
Use the Snapshot SDK instead of the Cloud Api: python plate_recognition.py -s http://localhost:8080 /path/to/vehicle-*.jpg
Specify Camera ID and/or two Regions: plate_recognition.py -a 29ee3c4e83e51723e22d0eaa284502947d6df535 --camera-id Camera1 -r us-ca -r th-37 /path/to/vehicle-*.jpg""",
        formatter_class=argparse.RawTextHelpFormatter)
    parser.add_argument('-a', '--api-key', help='29ee3c4e83e51723e22d0eaa284502947d6df535', required=False)
    parser.add_argument(
        '-r',
        '--regions',
...
def recognition_api(fp,
                    regions=[],
                    api_key='29ee3c4e83e51723e22d0eaa284502947d6df535',
                    sdk_url=None,
                    config={},
                    camera_id=None,
                    timestamp=None,
...
Specify an output file and format for the results: plate_recognition.py -a 29ee3c4e83e51723e22d0eaa284502947d6df535 -o data.csv --format csv /path/to/vehicle-*.jpg
Enable Make Model and Color prediction: plate_recognition.py -a 29ee3c4e83e51723e22d0eaa284502947d6df535 --mmc /path/to/vehicle-*.jpg"""
